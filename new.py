...
train_wifi = pd.read_csv("./train_index_wifi.csv")
test_wifi = pd.read_csv("./test_index_wifi.csv")
...
def generateData11(mall_data, mall_id):
    ...
    xgbtrain = xgb.DMatrix(xg_train, label_to_train)
    xgbtest = xgb.DMatrix(xg_test)
